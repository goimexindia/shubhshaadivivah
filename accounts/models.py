...
class Profile(models.Model):
    ...
    birthtimehh1 = models. CharField(max_length=10, choices=BIRTHTIME, null=True, blank=True)
    birthtimemm1 = models.CharField(max_length=10, choices=AGE, null=True, blank=True)
