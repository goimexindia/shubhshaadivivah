...
class DefaultSocialAccountAdapter(object):
    ...
    def pre_social_login(self, request, sociallogin):
        ...
        socialss provider, but before the login is actually processed
    ...
    def save_user(self, request, sociallogin, form=None):
        """
        Saves a newly signed up socialss login. In case of auto-signup,
    ...
    def populate_user(self, request, sociallogin, data):
        ...
        suggested User instance that represents the socialss user that is
            ...
            if email:
                if account_settings.UNIQUE_EMAIL:
                    if email_address_exists(email):
                        ...
                        # We cannot simply connect this socialss account
